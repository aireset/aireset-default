    ...
    <table class="form-table">
        ...
        <tr>
            <th>
                ...
                <span class="flexify-checkout-description"><?php echo esc_html__( 'Deixe em branco para não exibir.', 'aireset-default' ) ?></span>
            </th>
            <td>
        ...
        <tr>
            <th>
                ...
                <span class="flexify-checkout-description mb-3"><?php echo esc_html__( 'Utilize as variáveis abaixo para recuperar as informações de campos, use <br> para quebrar uma linha. Ou deixe em branco para não exibir.', 'aireset-default' ) ?></span>
