   ...
   <div class="cards-group ps-5 mb-5">
      <div class="card text-center p-0 m-4">
         ...
         <div class="card-body px-3 py-4 d-flex flex-column align-items-center text-center">
            <h5 class="card-title pt-0 border-top-0"><?php echo esc_html__( 'Flexify Checkout - Inter addon', 'aireset-default' ) ?></h5>
      ...
      <div class="card text-center p-0 m-4">
         ...
         <div class="card-body px-3 py-4 d-flex flex-column align-items-center text-center">
               <h5 class="card-title pt-0 border-top-0"><?php echo esc_html__( 'Joinotify', 'aireset-default' ) ?></h5>
               <p class="card-text fs-sm mb-4"><?php echo esc_html__( 'Automatize o envio de mensagens via WhatsApp ao receber eventos no Flexify Checkout, recupere vendas de maneira mais assertiva. Deixe tudo no fluxo certo sem esforço!', 'aireset-default' ) ?></p>

               <div class="badge bg-translucent-primary rounded-pill py-2 px-3 fs-md"><?php echo esc_html__( 'Em breve', 'aireset-default' ) ?></div>
         </div>
      ...
      <div class="card text-center p-0 m-4">
         ...
         <div class="card-body px-3 py-4 d-flex flex-column align-items-center text-center">
               <h5 class="card-title pt-0 border-top-0"><?php echo esc_html__( 'Google Maps', 'aireset-default' ) ?></h5>
               <p class="card-text fs-sm mb-4"><?php echo esc_html__( 'Facilite o preenchimento do endereço de entrega aos usuários, permitindo pesquisar seu endereço ou usando recursos de geolocalização com Google Maps.', 'aireset-default' ) ?></p>
