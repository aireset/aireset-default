   ...
   <table class="form-table">
      ...
      */
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="enable_aireset_defaul_disable_add_to_cart_message" name="enable_aireset_defaul_disable_add_to_cart_message" value="yes" <?php checked( Init::get_setting( 'enable_aireset_defaul_disable_add_to_cart_message') === 'yes' ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="enable_aireset_defaul_order_pay_without_login" name="enable_aireset_defaul_order_pay_without_login" value="yes" <?php checked( Init::get_setting( 'enable_aireset_defaul_order_pay_without_login') === 'yes' ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="enable_aireset_default_status_woocommerce" name="enable_aireset_default_status_woocommerce" value="yes" <?php checked( Init::get_setting( 'enable_aireset_default_status_woocommerce') === 'yes' ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="enable_aireset_default_auto_create_or_assign_customer_to_order" name="enable_aireset_default_auto_create_or_assign_customer_to_order" value="yes" <?php checked( Init::get_setting( 'enable_aireset_default_auto_create_or_assign_customer_to_order') === 'yes' ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="enable_aireset_default_images" name="enable_aireset_default_images" value="yes" <?php checked( Init::get_setting( 'enable_aireset_default_images') === 'yes' ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="enable_aireset_default_yith_wcas_submit_label" name="enable_aireset_default_yith_wcas_submit_label" value="yes" <?php checked( Init::get_setting( 'enable_aireset_default_yith_wcas_submit_label') === 'yes' ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="enable_aireset_default_custom_orders_list_column_content" name="enable_aireset_default_custom_orders_list_column_content" value="yes" <?php checked( Init::get_setting( 'enable_aireset_default_custom_orders_list_column_content') === 'yes' ); ?> />
            </div>
         </td>
      </tr>
