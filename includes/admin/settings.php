...
use Aireset\aireset-default\Init;
use Aireset\aireset-default\License;
...
<div class="flexify-checkout-admin-title-container">
    ...
    <h1 class="flexify-checkout-admin-section-tile mb-0"><?php echo esc_html( 'Flexify Checkout para WooCommerce', 'aireset-default' ) ?></h1>
...
<div class="flexify-checkout-admin-title-description">
    <p><?php echo esc_html__( 'Configure abaixo as opções da finalização de compra do WooCommerce. Se precisar de ajuda para configurar, acesse nossa', 'aireset-default' ) ?>
        <a class="fancy-link" href="<?php echo FLEXIFY_CHECKOUT_DOCS_LINK ?>" target="_blank"><?php echo esc_html__( 'Central de ajuda', 'aireset-default' ) ?></a>
    </p>
</div>
