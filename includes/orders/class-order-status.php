...
class OrderStatus {
    ...
    public function __construct() {
        if (Init::get_setting('aireset_default_status_woocommerce') === 'yes') {
            ...
            add_filter('admin_enqueue_scripts', [$this, 'custom_order_status_color']);
            add_filter('bulk_actions-edit-shop_order', [$this, 'add_custom_order_status_bulk_actions']);
            add_filter('woocommerce_reports_order_statuses', [$this, 'include_custom_order_status_in_reports']);
            add_filter( 'woocommerce_email_enabled', [$this, 'disable_all_woocommerce_emails'], 10, 2 );
            add_filter( 'wc_order_statuses', [$this, 'custom_rename_order_statuses'] );
            */
            /*
            add_filter( 'woocommerce_email_classes', [$this, 'register_custom_order_status_emails'] );
            add_filter( 'woocommerce_email_settings', [$this, 'custom_order_status_email_settings'] );
            add_filter( 'woocommerce_email_enabled', [$this, 'disable_specific_woocommerce_emails'], 10, 2 );
            */
        }
    }
     ...
     */
    public function custom_order_status_color() {
     ...
     */
    public function add_custom_order_status_bulk_actions($bulk_actions) {
     ...
     */
    public function aireset_include_custom_order_status_in_reports( $order_statuses ) {
     ...
     */
    public function aireset_disable_all_woocommerce_emails( $email_enabled, $email ) {
        return false;
    }
     ...
     */
    public function aireset_custom_rename_order_statuses( $order_statuses ) {
        if ( isset( $order_statuses['wc-processing'] ) ) {
            $order_statuses['wc-processing'] = _x( 'Pedido Pago', 'Order status', 'aireset-default' );
        }
        return $order_statuses;
    ...
    public function register_custom_order_status_emails( $email_classes ) {
    ...
    public function custom_order_status_email_settings( $settings ) {
        $settings[] = array(
            'title'    => 'Pedido Pago',
            'type'     => 'checkbox',
    ...
    public function disable_specific_woocommerce_emails( $email_enabled, $email ) {
