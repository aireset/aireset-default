...
<div class="aireset-default-admin-title-description">
    <p>
        <?php echo esc_html__( 'Configure abaixo as opções da finalização de compra do WooCommerce. Se precisar de ajuda para configurar, acesse nossa', 'aireset-default' ) ?>
        <a class="fancy-link" href="<?php echo AIRESET_DEFAULTDOCS_LINK ?>" target="_blank"><?php echo esc_html__( 'Central de ajuda', 'aireset-default' ) ?></a>
    </p>
</div>
...
<div class="aireset-default-wrapper">
    ...
    <form method="post" class="aireset-default-form" name="aireset-default">
        <?php
            include_once AIRESET_DEFAULT_INC_PATH . 'admin/tabs/options.php';
            ...
            include_once AIRESET_DEFAULT_INC_PATH . 'admin/tabs/about.php';
