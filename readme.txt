...
== Description ==
Este é um plugin com configurações padrões para Woocommerce para o mercado brasileiro criadas por nossa agência

== Installation ==
Nosso processo de instalação é simples, basta instalar que todas as configurações serão aplicadas.
