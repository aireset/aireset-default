 ...
 */
add_action('wp', 'aireset_agendar_verificacao_pedidos');

function aireset_agendar_verificacao_pedidos() {
 ...
 */
register_deactivation_hook( __FILE__, 'aireset_desativar_verificacao_pedidos' );

function aireset_desativar_verificacao_pedidos() {
 ...
 */
add_action( 'verificar_pedidos', 'aireset_verificar_e_atualizar_pedidos' );

function aireset_verificar_e_atualizar_pedidos() {
